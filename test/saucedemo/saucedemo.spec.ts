...
test.describe('Saucedemo website automation', () => {
  test('standard user can log in and see inventory', async ({ pageFactory }) => {
    const loginPage = pageFactory.loginPage();
    const inventoryPage = pageFactory.inventoryPage();
  ...
  test('locked out user gets login error', async ({ pageFactory }) => {
    const loginPage = pageFactory.loginPage();
  ...
  test('standard user can add item to cart and complete checkout', async ({ pageFactory }) => {
    const loginPage = pageFactory.loginPage();
    const inventoryPage = pageFactory.inventoryPage();
    const cartPage = pageFactory.cartPage();
    const checkoutPage = pageFactory.checkoutPage();
